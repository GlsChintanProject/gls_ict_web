...
$e_id = $_GET['event_id'];
$query = $sql->query("select * from event_year where event_id = '$e_id'");
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-5">
                            <form class="form-horizontal" method="post">
                                ...
                                <label class="col-lg-3 control-label" for="year">Enter Event Name :</label>
                                <div class="col-lg-9">
                                <input type="text" class="form-control" name="e_title" placeholder="Enter event Title" value="<?php echo $row['event_title']; ?>">
                                </div>
                                </div>
                                <div class="form-group">
                            ...
                            <?php
                                if(isset($_POST['submit_event']))
                                {
                                    ...
                                    $title = $_POST['e_title'];
                                    $time = strtotime("now");
                                    $query = "update event_year set event_year = '$year' , event_title = '$title' , event_timestamp = '$time' where event_id = '$e_id'";
                                    $sql->query($query);
